...
public class AddPostActivity extends AppCompatActivity {
    ...
    DatabaseReference reference = firebaseDatabase.getReference().child("usersPosts");
...
//
//                    UsersPost userspost = snapshot1.getValue(UsersPost.class);
//                    String retrievedUsernames = userspost.getUsername();
